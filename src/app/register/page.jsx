...
const Register = () => {
  ...
  const [eyeCloseConfirmPasswd, setEyeCloseConfirmPasswd] = React.useState(true);
            ...
            {eyeCloseConfirmPasswd ? (
              <>
                <input
                  ...
                  className={`${passwordConfirm === password && password.length >= 5 ? 'focus:ring-green-500 focus:border-green-500' : (passwordConfirm !== password && password.length >= 5) ? 'focus:ring-red-500 focus:border-red-500' : '' } bg-white border relative border-slate-300 rounded-2xl px-10 py-2 text-center peer`}
                ...
                {passwordConfirm === password && password.length >= 5 ? (
                  <>
                    <p className="peer-focus:block hidden text-xs text-green-500 mt-2">password cocok</p>
                  </>
                ) : passwordConfirm !== password && password.length >= 5 ? (
                  <>
                    <p className="peer-focus:block hidden text-xs text-red-500 mt-2">password tidak cocok</p>
                  </>
                ) : (
                  <></>
                )}
